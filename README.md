...
- 可配置专辑封面尺寸
- 可选臻品母带, 臻品全景声, FLAC, MP3_320, MP3_128音质，自动降级
...
访问 `http://<服务器ip:NA端口>/plugins/GeQian.order_qqmusic/remove` 可以删除凭证
...
- v2.3.0: 新增臻品母带/臻品全景声/臻品音质支持
  - 支持 MASTER, ATMOS_2, ATMOS_51 音质选项
